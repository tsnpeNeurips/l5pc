...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 SK_E2 /path/path/path/path/tsnpe_collection/l5pc/l5pc/model/mechanisms/SK_E2.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/path/path/path/path/tsnpe_collection/l5pc/l5pc/model/mechanisms/SK_E2.mod";
static const char* nmodl_file_text = 
