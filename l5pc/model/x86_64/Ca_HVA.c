...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ca_HVA /path/path/path/path/tsnpe_collection/l5pc/l5pc/model/mechanisms/Ca_HVA.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/path/path/path/path/tsnpe_collection/l5pc/l5pc/model/mechanisms/Ca_HVA.mod";
static const char* nmodl_file_text = 
  ":Comment :\n"
